...
from solana.publickey import PublicKey  # ✅ Needed for Token API compatibility
...
st.title("🪙 LaunchTool Clone — FINAL FIXED VERSION")
...
# ✅ Convert solders.Pubkey to solana.PublicKey for SPL Token
